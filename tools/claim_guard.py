...
generate_seo_article.py):
  ...
  - The rating is 5.0 from 121 reviews. No other figure may appear.
...
RULES = [
    ...
    (
        'rating',
        # Any star rating or review count that is not the real 5.0 / 121.
        r'\b(?!5\.0\b)[0-5]\.\d\s*(?:[-– ]?star|stars|/\s*5|out of 5)'
        r'|\b(?!121\b)\d{1,4}\+?\s+(?:google\s+)?reviews\b',
        'The real figures are 5.0 stars from 121 reviews. Do not use any other number.',
        None,
    ),
    (
        'response-promise',

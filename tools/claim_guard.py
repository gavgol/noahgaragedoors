...
generate_seo_article.py):
  ...
  - The rating is 5.0 from 84 reviews. No other figure may appear.
...
RULES = [
    ...
    (
        ...
        r'|\b(?!84\b)\d{1,4}\+?\s+(?:google\s+)?reviews\b',
        'The real figures are 5.0 stars from 84 reviews. Do not use any other number.',
        None,
    ),
    (
        'response-promise',

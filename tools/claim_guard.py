...
generate_seo_article.py):
  ...
  - The rating is 4.9 from 41 reviews. No other figure may appear.
...
RULES = [
    ...
    (
        'rating',
        # Any star rating or review count that is not the real 4.9 / 41.
        r'\b(?!4\.9\b)[0-5]\.\d\s*(?:[-– ]?star|stars|/\s*5|out of 5)'
        r'|\b(?!41\b)\d{1,4}\+?\s+(?:google\s+)?reviews\b',
        'The real figures are 4.9 stars from 41 reviews. Do not use any other number.',
        None,
    ),
    (
        'response-promise',
